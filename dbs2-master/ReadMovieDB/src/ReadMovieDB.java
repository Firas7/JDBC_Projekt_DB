...
/* K:
 * ReadMovieDB liest Daten Anhand einer ID aus einer MovieDatenbank und gibt sie aus.
 * Die ID wird als Kommandozeilenparameter beim Start des Programms übergeben.
 * Wird das Programm ohne ID oder mit falscher ID gestartet, wird eine Liste der gespeicherten
 * Filmen ausgegeben und das Programm endet.
 */
 ...
 */
	...
	/*
	 * sqlAbfrage() führt das SQL Query aus und speichert das Ergebnis in dem
	 * ResultSet "rs".
	 */
	private static void sqlAbfrage() {
		try {
			Statement stmt = conn.createStatement();
			setRs(stmt.executeQuery(sql));					// führt das SQL Query aus und speichert das ResultSet in "rs"
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println(e); // Ausgabe Fehlermeldung
